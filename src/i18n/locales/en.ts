...
const en: Translation = {
  ...
  booking: {
    ...
    timeSlotsHint: "Greyed slots are full or already past — pick another time",
    rebook: "Re-book",
    rebookBannerTitle: "Reused your last booking — only the time is left to pick",
    rebookBannerHint: "Pet type and notes were prefilled. Review and tweak below if needed.",
  },
  safety: {
  ...
  technician: {
    ...
    loadMore: "View more history",
    noReviews: "No reviews under this level yet.",
  },
  emergency: {
    fab: "Emergency",
    ...
    eta: "Estimated response",
    minutes: "minutes",
    ticketNo: "Ticket No.",
    ticketOpen: "Open · in queue",
    trackable: "Track this ticket in My Reports anytime.",
